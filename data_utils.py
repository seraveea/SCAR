...
def process_images_in_parallel(images: List[PIL.Image.Image], transform , num_workers: int = 4):
    """
    Process a list of images in parallel using the specified transform.
