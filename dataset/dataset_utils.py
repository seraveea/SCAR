...
GLD_image_path = "../../datasets/OMGM_data/E-VQA/landmarks"
iNat_image_path = "../../datasets/OMGM_data/E-VQA/inaturalist"
infoseek_val_path = "../../datasets/OMGM_data/InfoSeek/infoseek_val_images"
