...
_VOCAB_PATH = '/data/user/seraveea/research/vqa_data/evqa_eval/bert_uncased_vocab.txt' #相对路径
_MODEL_PATH = '/data/user/seraveea/research/hugging_face_cache/bert-tensorflow2-answer-equivalence-bem-v1' # 绝对路径
